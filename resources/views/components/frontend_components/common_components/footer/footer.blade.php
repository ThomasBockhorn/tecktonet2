					...
					<div class="row">
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="single-footer">
								<div class="logo">
									<img  width="100%" height="100%" src="{{ asset('img/Black_tecktonet_logo.png')}}" alt="logo">
								</div>
								<p>Let me help you build a website that you can be proud of.</p>
								<div class="contact">
									<p class="mail-add"><i class="fas fa-envelope" aria-hidden="true"></i>Thomas.Bockhorn@tecktonet.com</p>
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="single-footer">
								...
								<span><i class="fa fa-caret-right" aria-hidden="true"></i><a href="#Services">services</a></span>
								<span><i class="fa fa-caret-right" aria-hidden="true"></i><a href="#latest-works">portfolio</a></span>
								...
								<span><i class="fa fa-caret-right" aria-hidden="true"></i><a href="#contact">contact</a></span>
							</div>
						</div>
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="single-footer">
